...
export interface ApiDentistaDentista extends Struct.CollectionTypeSchema {
  collectionName: 'dentistas';
  info: {
    displayName: 'Dentista';
    pluralName: 'dentistas';
...
export interface ApiExpedienteExpediente extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estado: Schema.Attribute.Enumeration<
      ['Activo', 'Inactivo', 'Archivado', 'Tratamiento']
    > &
      Schema.Attribute.Required &
...
export interface ApiResumenClinicoResumenClinico
  extends Struct.CollectionTypeSchema {
  collectionName: 'resumen_clinicos';
  info: {
    displayName: 'Resumen_Clinico';
    pluralName: 'resumen-clinicos';
    singularName: 'resumen-clinico';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Seguimiento: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiServicioServicio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Categoria: Schema.Attribute.Enumeration<
      ['preventivo', 'restaurativo', 'ortodoncia', 'emergencia']
    > &
      Schema.Attribute.Required;
    Costo_base: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
    ...
    Duracion_Minutos: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    Nombre_Servicio: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dentista.dentista': ApiDentistaDentista;
      ...
      'api::resumen-clinico.resumen-clinico': ApiResumenClinicoResumenClinico;
